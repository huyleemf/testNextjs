...
import type, { siteActionType } from "redux/actionTypes";
      ...
      <div className="container">
        ...
        <div className="box-right">
          <ul className="list">
            ...
            <li>
              <Link to={PathRoute.SchoolTraining}>School Partnerships</Link>
            </li>
            <li>
              <a
            ...
            <li>
              <Link to={PathRoute.ListQNA}>FAQs</Link>
            </li>
          </ul>
          <ul className="list">
            <li>
            ...
            <li>
              <Link to={PathRoute.HomeNews}>Training Tips</Link>
            </li>
            <li>
        ...
        <div className="Social">
          ...
          <div className="menu-ft">
            ...
            <Link to={PathRoute.ListQNA}> FAQ</Link>
            <span>|</span>
