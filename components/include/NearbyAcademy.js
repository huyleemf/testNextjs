...
import { siteActionType, headerActionType } from "redux/actionTypes";
  ...
  return (
    <div className="custom-select" ref={wrapperRef}>
      <div
        ...
        onClick={() => {
          if (nearbyAcademy && nearbyAcademy.ms_id) setShowSelect(!showSelect);
          else {
            setShowSelect(false);
            dispatch({
        ...
        <div className="wrap">
          <div className="wraphead">
            <h3>
              ...
              <span className="name"> {nearbyAcademy?.ms_name}</span>
            </h3>
            <a
              href="/#"
              onClick={(e) => {
