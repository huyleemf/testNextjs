          ...
          <div className="container">
            ...
            <ul className="menu">
              <li className="menu-link">
                <Link to={PathRoute.WeeklyTraining} onClick={hideMenu}>
                  Weekly Training
                </Link>
              </li>
              <li className="menu-link">
                <Link to={PathRoute.HolidayCamp} onClick={hideMenu}>
                  Holiday Camps
                </Link>
              </li>
              <li className="menu-link">
                <Link to={PathRoute.OneTraining} onClick={hideMenu}>
                  1-on-1 Training
                </Link>
              </li>
              <li className="menu-link">
                <Link to={PathRoute.BirthdayParty} onClick={hideMenu}>
                  Birthday Parties
                </Link>
              </li>
              <li>
        ...
        <div className="menu-down">
          <div className="container">
            ...
            <ul className="menu-small">
              ...
              <li className="menu-link">
                <Link to={PathRoute.Contact} onClick={hideMenu}>
                  Contact Us
                </Link>
              </li>
              <li className="menu-link">
