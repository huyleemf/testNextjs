  ...
  >
    ...
    <g id="Page-1" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
      <g
        ...
        fillRule="nonzero"
      >
        <g id="facebook-square" transform="translate(569.000000, 683.000000)">
          <path
  ...
  >
    ...
    <g id="Page-1" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
      <g
        ...
        fillRule="nonzero"
      >
        <g id="twitter-square" transform="translate(693.000000, 683.000000)">
          <path
  ...
  >
    ...
    <g id="Page-1" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
      <g
        ...
        fillRule="nonzero"
      >
        <g id="instagram-square" transform="translate(819.000000, 683.000000)">
          <path
...
export default function ThankYou() {
  ...
  const { footerConfig } = siteReducer;

  useEffect(() => {
    setSocialMedia(footerConfig.cfg_value);
  }, [siteReducer]);

  return (
    <div style={{ backgroundColor: "#F2F2F2", padding: "4rem 0" }}>
      <div className="container thank-you" style={{ textAlign: "center" }}>
        <h2
          style={{
            marginBottom: "0.5rem",
        ...
        <b style={{ padding: "4rem 0" }}>
          While you wait for a responese, follow us out on social media:
        </b>
        <div
          style={{
            marginTop: "2rem",
              ...
              if (item.title === "Facebook")
                return (
                  <a
                    key={index}
                    href={
                      item && item.des && item.des.length > 3 ? item.des : "#"
                    }
                  >
                    {fbIcon}
                  </a>
        ...
        >
          ...
          <p style={{ color: "rgba(26,25,25,0.7)" }}>
            If you are interested in running your own We Make Footballers
